"""
Django settings for late_bird_42611 project.
...
ROOT_URLCONF = 'late_bird_42611.urls'
...
WSGI_APPLICATION = 'late_bird_42611.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_bird_42611 API",
    "DESCRIPTION": "API documentation for late_bird_42611 App",
    "VERSION": "v1",
}
